...
function CategoryProduct({ inputSearch }) {
  ...
  useEffect(() => {
    ...
    return (
      <div>
        {
          categoryProduct.filter(({title}) => title.toUpperCase().search(inputSearch?.toUpperCase()) >= 0).map((data) => {
            return(
                <div className = "product-layout col-md-6 col-sm-6 col-xs-12 col-lg-12" key={Math.random()}>
                  ...
                  <div className="right-block col-md-8">
                    <div className="caption">
                      ...
                      <div className="price">
                        ...
                        <span className="label label-percent">{data.discount !== "No" ? data.discount : ""}</span>
                      </div>
